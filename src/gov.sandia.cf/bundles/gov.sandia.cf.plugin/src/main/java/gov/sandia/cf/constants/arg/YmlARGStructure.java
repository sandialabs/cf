...
public class YmlARGStructure {
	...
	public static final String ARG_STRUCTURE_ORIENTATION_KEY = "orientation"; //$NON-NLS-1$
	...
	public static final String ARG_STRUCTURE_N_FIGURE = "figure"; //$NON-NLS-1$
	public static final String ARG_STRUCTURE_N_HTML_KEY = "html"; //$NON-NLS-1$
	...
	public static final String ARG_STRUCTURE_TABLE_HEADER_BACKGROUNDCOLOR = ConstantTheme
			.getColor(ConstantTheme.COLOR_NAME_PRIMARY);
	public static final String ARG_STRUCTURE_TABLE_HEADER_FOREGROUNDCOLOR = ConstantTheme
			.getColor(ConstantTheme.COLOR_NAME_WHITE);

	/**
	 * ARG structure html Keys
	 */
	public static final String ARG_STRUCTURE_HTML_STRING_KEY = "html_string"; //$NON-NLS-1$
	...
	/**
	 * ARG structure figure Keys
	 */
	public static final String ARG_STRUCTURE_FIGURE_ARGS_KEY = "arguments"; //$NON-NLS-1$
	public static final String ARG_STRUCTURE_FIGURE_WIDTH_KEY = "width"; //$NON-NLS-1$
	public static final String ARG_STRUCTURE_FIGURE_FILE_KEY = "figure_file"; //$NON-NLS-1$
	public static final String ARG_STRUCTURE_FIGURE_CAPTION_KEY = "caption_string"; //$NON-NLS-1$
	public static final String ARG_STRUCTURE_FIGURE_LABEL_KEY = "label"; //$NON-NLS-1$
