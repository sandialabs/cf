 ...
 *
 */
public class YmlWriterPCMMData implements IYmlDataWriter {
	...
	public void writeData(final Yaml yamlEngine, final File cfDataFile, final Map<ExportOptions, Object> exportOptions,
		...
		if (!exportOptions.containsKey(ExportOptions.PCMM_INCLUDE)
		...
		try (Writer writer = new StringWriter()) {
			...
			yamlEngine.dump(ExportOptionsMapper.getYmlPCMMData(exportOptions), writer);
