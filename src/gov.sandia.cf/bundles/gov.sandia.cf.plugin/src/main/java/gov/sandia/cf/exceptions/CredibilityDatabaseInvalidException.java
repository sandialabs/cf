 ...
 *
 */
public class CredibilityDatabaseInvalidException extends Exception {
	/**
	 * serial version UID
	 */
	 ...
	 */
	public CredibilityDatabaseInvalidException() {
		super();
	}
	 ...
	 */
	public CredibilityDatabaseInvalidException(String message) {
		super(message);
	}
	 ...
	 *
	 */
	public CredibilityDatabaseInvalidException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 *
	 */
	public CredibilityDatabaseInvalidException(Throwable cause) {
		super(cause);
	}
}
