...
public class PIRTQoIDescriptionDialog extends GenericCFSmallDialog<PIRTViewManager> {
	 ...
	 */
	public PIRTQoIDescriptionDialog(PIRTViewManager viewManager, Shell parentShell, ViewMode mode) {
	...
	protected Control createDialogArea(Composite parent) {
		...
		if (this.mode.equals(ViewMode.UPDATE)) {
			// text description - configure editor
			editorDescription = FormFactory.createRichText(formContainer, null);
	...
	protected void okPressed() {
		// Set text
		qoi.setDescription(StringTools.removeNonPrintableChars(editorDescription.getText()));
		super.okPressed();
	}
