 ...
 *
 */
public class NewCredibilityEvidenceStructureWizard extends Wizard implements INewWizard {

	/**
	 * the logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(NewCredibilityEvidenceStructureWizard.class);

	/**
	 * the page to select parent project and create credbility evidence structure
	 * folder
	 */
	private CredibilityEvidenceStructureWizardPage pageCredibilityStructureFolder;

	/**
	 * The constructor
	 */
	public NewCredibilityEvidenceStructureWizard() {
		super();
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		pageCredibilityStructureFolder = new CredibilityEvidenceStructureWizardPage(selection);
	}
