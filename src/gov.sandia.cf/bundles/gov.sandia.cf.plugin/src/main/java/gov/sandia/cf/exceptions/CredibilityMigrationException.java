 ...
 *
 */
public class CredibilityMigrationException extends Exception {
	/**
	 * serial version UID
	 */
	 ...
	 */
	public CredibilityMigrationException() {
		super();
	}
	 ...
	 */
	public CredibilityMigrationException(String message) {
		super(message);
	}
	 ...
	 *
	 */
	public CredibilityMigrationException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 *
	 */
	public CredibilityMigrationException(Throwable cause) {
		super(cause);
	}
}
