 ...
 *
 */
public class YmlWriterUncertaintyData implements IYmlDataWriter {
	...
	public void writeData(final Yaml yamlEngine, final File cfDataFile, final Map<ExportOptions, Object> exportOptions,
		...
		if (!exportOptions.containsKey(ExportOptions.UNCERTAINTY_INCLUDE)
		...
		try (Writer writer = new StringWriter()) {
			...
			yamlEngine.dump(ExportOptionsMapper.getYmlUncertaintyData(exportOptions), writer);
