...
public interface IImportApplication extends IApplication {
	 ...
	 */
	<M extends IImportable<M>> void importChanges(Model model,
	 ...
	 */
	void importConfiguration(Model model, ConfigurationSchema confSchema) throws CredibilityException, IOException;
