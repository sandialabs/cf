...
/**
 * Migration of PCMM Planning and Uncertainty fields from VARCHAR to
 * LONGVARCHAR.
 * 
 * @author Didier Verstraete
 *
 */
public class Task_003_PlanningFieldLongVarchar implements IMigrationTask {

	/**
	 * the logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(Task_003_PlanningFieldLongVarchar.class);

	private static final String TASK_NAME = "0.6.0-iwfcf-322.sql"; //$NON-NLS-1$

	private static final String SCRIPT_NAME = "0.6.0-iwfcf-322.sql"; //$NON-NLS-1$
