...
public interface IReportARGApplication extends IApplication {
	 ...
	 * @throws CredibilityException if an error occurs during CF variable parsing
	 */
	void generateGenericValues(List<Map<String, Object>> parentSections, IGenericTableItem item,
	 ...
	 */
	Map<String, Object> generateSection(String title, String text, List<Map<String, Object>> subsections, ARGOrientation orientation);
	 ...
	 */
	Map<String, Object> generateSubSection(String title, String text, List<Map<String, Object>> subsections, ARGOrientation orientation);
	 ...
	 */
	Map<String, Object> generateSubsubSection(String title, String text, List<Map<String, Object>> subsections, ARGOrientation orientation);
	...
	/**
	 * Inline image into an existing document
	 * 
	 * @param section the section to add the image into
	 * @param path    the document path
	 * @param caption the caption
	 * @param label   the label
	 * @return the map section containing an ARG section with the image document
	 */
	Map<String, Object> generateImage(Map<String, Object> section, String path, String caption, String label);

	/**
	 * Create a html paragraph with content
	 * 
	 * @param htmlValue the html value
	 * @return the html paragraph populated
	 */
	Map<String, Object> generateHtmlParagraph(String htmlValue);
