...
public abstract class ATooltipTableLabelProvider extends CellLabelProvider {
	/**
	 * viewer
	 */
	 ...
	 */
	public ATooltipTableLabelProvider(ColumnViewer viewer) {
		// Add Fancy ToolTip
	...
	public void update(ViewerCell cell) {
		...
		cell.setForeground(ConstantTheme.getAssociatedColor(getBackground(element, cell.getColumnIndex())));
	}
