...
class YmlReaderPCMMSchemaTestDefaultMode extends AbstractConfigurationTest {

	/**
	 * the logger
	 */
	public static final Logger logger = LoggerFactory.getLogger(YmlReaderPCMMSchemaTestDefaultMode.class);
