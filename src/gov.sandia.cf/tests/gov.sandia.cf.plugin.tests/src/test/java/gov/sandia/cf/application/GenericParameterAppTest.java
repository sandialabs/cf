...
class GenericParameterAppTest extends AbstractTestApplication {
	...
	@Test
	void test_getReadableValue_Value_null() {

		// test
		String returnedValue = getAppManager().getService(IGenericParameterApplication.class).getReadableValue(null);
	...
	@Test
	void test_getReadableValue_Parameter_null() {

		GenericValue<?, ?> newAnonymousGenericValue = TestEntityFactory.getNewAnonymousGenericValue();
		newAnonymousGenericValue.setParameter(null);
		newAnonymousGenericValue.setValue("Bla"); //$NON-NLS-1$

		// test
		String returnedValue = getAppManager().getService(IGenericParameterApplication.class)
				.getReadableValue(newAnonymousGenericValue);
	...
	@Test
	void test_getReadableValue_Type_blank() {
		...
		parameter.setType(RscTools.empty());
		GenericValue<TestGenericParam, ?> newAnonymousGenericValue = TestEntityFactory.getNewAnonymousGenericValue();
		newAnonymousGenericValue.setParameter(parameter);
		newAnonymousGenericValue.setValue(newPCMMElement.getId().toString());
	...
	@Test
	void test_getReadableValue_Type_credibility_element() {
		...
		// validate
		assertEquals(newPCMMElement.getAbstract(), returnedValue);
	}

	@Test
	void test_getReadableValue_Type_system_requirement() {
		...
		SystemRequirementValue newAnonymousGenericValue = TestEntityFactory
				.getNewSystemRequirementValue(getDaoManager(), null, parameter, null);
		newAnonymousGenericValue.setParameter(parameter);
		newAnonymousGenericValue.setValue(newSystemRequirement.getId().toString());
		...
		// validate
		assertEquals(newSystemRequirement.getAbstract(), returnedValue);
	}

	@Test
	void test_getReadableValue_Type_other() {

		TestGenericParam parameter = TestEntityFactory.getNewTestGenericParameter();
		parameter.setName("Param"); //$NON-NLS-1$
		parameter.setType(FormFieldType.RICH_TEXT.getType());
		GenericValue<TestGenericParam, ?> newAnonymousGenericValue = TestEntityFactory.getNewAnonymousGenericValue();
		newAnonymousGenericValue.setParameter(parameter);
		newAnonymousGenericValue.setValue("My content <br>value with html <g>tags</g>"); //$NON-NLS-1$
		...
		// validate
		assertEquals(gov.sandia.cf.tools.StringTools.clearHtml(newAnonymousGenericValue.getReadableValue()),
				returnedValue);
	}
	...
	void test_isParameterAvailableForLevel_AllLevels() {
		...
		boolean returned = getAppManager().getService(IGenericParameterApplication.class)
	...
	void test_getParameterNameWithRequiredPrefix_Required_blank() {
		...
		String returned = getAppManager().getService(IGenericParameterApplication.class)
	...
	@Test
	void test_isValid_Required_Valid() {
		...
		// test
		boolean returned = getAppManager().getService(IGenericParameterApplication.class).isValid(value, null);
	...
	@Test
	void test_isValid_Required_NotValid() {
	...
	void test_checkValid_NoConstraints() {
		...
		Notification returned = getAppManager().getService(IGenericParameterApplication.class).checkValid(value,
	...
	void test_checkValid_Required_Valid() {
		...
		// the generic value to compare with
		Notification returned = getAppManager().getService(IGenericParameterApplication.class).checkValid(value, null);
	...
	void test_checkValid_WithMaxConstraint_Error_bad_EL() {
		...
		tableValue.setValue("2.2"); //$NON-NLS-1$
		tableValue.setParameter(parameter2);
		Notification returned = getAppManager()
				.getService(IGenericParameterApplication.class).checkValid(value,
				Arrays.asList(tableValue));
	...
	void test_sortTableValuesByParameterId_Null() {
		...
		List<IGenericTableValue> valuesSorted = getAppManager().getService(IGenericParameterApplication.class)
